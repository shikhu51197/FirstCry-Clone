        ...
        <div className="cardDiv">
          ...
          <a href="#">
            <div className="card">
              ...
              />
              <p style={{ marginTop: "10px" }}>
                The Irresistible Deal | Up to 10+Y
              </p>
          ...
          <a href="#">
            <div className="card">
              ...
              />
              <p style={{ marginTop: "10px" }}>
                Chilling In New Fastion | Up To 12+Y
              </p>
          ...
          <a href="#">
            <div className="card">
              ...
              />
              <p style={{ marginTop: "10px" }}>
                Deals You Can't Resist | Up 4 to 12Y
              </p>
