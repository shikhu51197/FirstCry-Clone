  ...
  return (
    <div>
      <div style={{display:"flex",alignItems:"center"}} >
        <Text fontSize={{sm:"16px",md:"12px",lg:"20px"}} marginRight={"20px"} fontWeight="bold" fontStyle={"italic"} >Total Price:-₹{price?price:0}/</Text>
        <Button ref={btnRef} colorScheme="teal" onClick={onOpen} fontSize="12px">
          PLACE ORDER
        </Button>
        <Drawer
          isOpen={isOpen}
