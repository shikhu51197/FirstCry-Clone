        ...
        <div className="account-card-shadow p-3">
          <div className="row">
            ...
            <div className="col-md-9 col-12">
              <h3 className="fw-bold account-sub-head mb-3">My Profile</h3>
              <div className="card">
                {UserData &&
                  UserData.map((user) => (
                    <div className=" profile-card-shadow mt-3" key={user.id}>
                      <div className="p-4">
                        <div className="row">
                          <div className="col-6">
                            <div>
                          ...
                          <div className="row">
                            ...
                            <div className="col-6">
                              ...
                              <p className="font-desc mt-3">
                                ...
                                stores too! To earn Club Cash on store
                                purchases, simply provide your verified mobile
                                number at the time of billing.
                              </p>
                            </div>
                          </div>
                        </div>
                      ...
                      <div className="">
                        ...
                        <div className="p-3">
                          <div
                            ...
                            role="alert"
                          >
                            Please enter your child details so that we can help
                            in choosing the best products for your child
                          </div>
                          {user.child.length == 0 ? (
                            <div className="row">
                              <div className="col-8">
                      ...
                      <div className="">
                        ...
                        <div className="p-3">
                          ...
                          >
                            ...
                            with 1 Uppercase, 1 Lowercase & 1 Numeric character
                          </div>
                          <div className="row">
                            <div className="col-8">
                              <div className="mb-3 row">
